...
export const forgotPassMail = (
  ...
  const msg = {
    ...
    subject: '【Restyle;インテリアAIサービス】パスワード再設定のご連絡',
    text: 'パスワードをリセットするには、下のリンクをクリックしてください',
    html: `<h4>このたびは、”Restyle;AIサービス”にご登録いただきまして
    まことにありがとうございます。</h4>
  ...
  お手数ですが、以下のアドレスまでご報告ください。</h4>
    <a style="text-decoration: none;" href="mailto:info@getrestyle.com">~~~~~~~~~~~~~~~~~info@getrestyle.com~~~~~~~~~~~~~~~~~</a>`,
  };
